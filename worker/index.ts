function goodRing(start: number, n_Nodes: number): void {
  console.log(start, n_Nodes);
  /**
  ...
  function initGraph() {
    ...
    postMessage({ squareData: squareUpdateData });
  }
...
addEventListener("message", (e) => {
  goodRing(e.data.start, e.data.n_Nodes);
});
